...
import ProductionReport from "@/components/dashboard/ProductionReport";
...
export default function SimulatorPage() {
  ...
  return <>
    ...
    <div className="simulator-grid"><SimulationControls sim={sim} onChange={patch} onAnalyze={analyze} loading={loading} lang={lang} /><div className="simulator-results"><EnergyOverview calc={calc} batteryLevelPct={sim.batteryLevelPct} lang={lang} /><EnergyFlow calc={calc} batteryLevelPct={sim.batteryLevelPct} batteryCapacityWh={sim.batteryCapacityWh} active={decision.recommendedAction} lang={lang} /><ProductionReport /><AIRecommendation /></div></div>
  </>;
}
